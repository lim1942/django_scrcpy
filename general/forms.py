...
class MobileForm(forms.ModelForm):
    ...
    video_encoder = forms.CharField(label='视频codec_encoder', required=False, help_text="若无画面请尝试以下某一：OMX.google.h264.encoder | OMX.qcom.video.encoder.hevc | c2.android.hevc.encoder | c2.mtk.hevc.encoder")
    ...
    audio_encoder = forms.CharField(label='音频codec_encoder', required=False, help_text="若无音频请尝试以下某一：OMX.google.aac.encoder | c2.android.opus.encoder | c2.android.aac.encoder")
